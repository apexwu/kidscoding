...
function check_passwd(pw1,pw2){
	...
	for(var idx=0;idx<pw1.length;idx++){
		if(pw1.charCodeAt(idx)>= 48 && pw1.charCodeAt(idx) <= 57){
			x=1;
		}
		if(pw1.charCodeAt(idx)>= 65 && pw1.charCodeAt(idx) <= 90){
			y=1;
		}
		if(pw1.charCodeAt(idx)>= 97 && pw1.charCodeAt(idx) <= 122){
			z=1;
		}
      ...
      <tr valign="top">
        <td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          ...
          <div class="dataDiv">
            ...
            <font color="#FF0000">*</font><br><span class="smalltext">請填入8~10個字元以內的英文字母、數字、以及各種符號組合，</span></p>
            ...
            <font color="#FF0000">*</font><br><span class="smalltext"></span></p>
