    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="bossup.php">管理修改</a>
            </li>
			<li class="nav-item">
            ...
            <table class="table table-striped">
              <thead>
                ...
                <?php 
                 ...
                 $sql = ("SELECT * FROM eatup ");
                 
                 $result = mysqli_query($conn, $sql);
                 while ($row = @mysqli_fetch_row($result))
				 { ?>
                   <tr>
				 <td><input type="button" value="核准" class="btn" onclick="location.href='bossupok.php?id=<?php echo $row[13]?>'"/></td>
				 <td><input type="button" value="取消" class="btn" onclick="location.href='bossupno.php?id=<?php echo $row[13]?>'"/></td>
