    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
			...
			<li class="nav-item">
              <a class="nav-link active" href="bossin.php">管理新增</a>
            </li>
            ...
            <table class="table table-striped">
              <thead>
                ...
                <?php 
                 ...
                 $sql = ("SELECT * FROM eatin ");
                 
                 $result = mysqli_query($conn, $sql);
                 while ($row = @mysqli_fetch_row($result))
				 { ?>
                   <tr>
				 <td><input type="button" value="核准" class="btn" onclick="location.href='bossinok.php?id=<?php echo $row[0]?>'"/></td>
				 <td><input type="button" value="取消" class="btn" onclick="location.href='bossinno.php?id=<?php echo $row[0]?>'"/></td>
