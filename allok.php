...
<tr>
　    <td>地址</td>
　    <td><a href=http://maps.google.com.tw/maps?q=<?php echo $rs[6]; ?>>  <?php echo $rs[6]?></a></td>
　</tr>
<tr>
　    <td>簡介</td>
　    <td><?php echo $rs[8]?></td>
...
　  <!--  <td><img src="imageView.php?image_id=<?//php echo $rs[9]; ?>" style="width: 100px; height:auto;"/></td>
    -->
	  <td><img  width="304"  src="picture/<?php echo $rs[9];?>"/></td>
　</tr>
<tr>
　    <td>菜單</td>
　  <!--  <td><img src="imageView.php?image_id=<?//php echo $rs[10]; ?>" style="width: 100px; height:auto;" /></td>
    -->　
	  <td><img  width="304"  src="picture/<?php echo $rs[10];?>"/></td>
</tr>
<tr>
　    <td>更新者</td>
　    <td><?php echo $rs[1]?></td>
