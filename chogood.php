...
font-family: "Helvetica Neue", Helvetica, Arial, "微軟正黑體", "微软雅黑", "メイリオ", "맑은 고딕", sans-serif;font-size:108%;}
  ...
  $kchoice=$_REQUEST['kchoice'];
   echo "<script>alert('關鍵字包含詳細資料內的文字(如果未輸入關鍵字將出現所有資料!)');</script>";
  //echo "<script>alert("關鍵字包含詳細資料內的文字\n如果未輸入關鍵字將出現所有資料!"); </script>";
  ...
  <thead>
    <tr>
      ...
      <th scope="col">內容</th>
      <th scope="col">地圖</th>
      <th width="100" scope="col">詳細資料</th>
    </tr>
  </thead>
  ...
  <tbody>
     ...
     <?php  if ($result->num_rows <= 0) { ?>
            ...
            <tr>
              ...
              <th><a href=allok.php?id=<?php echo $row["id"]?>>詳細資料</a></th>
            </tr>
            <?php } } ?>
  </tbody>
   </table>
